 ...
 * // http://sathyababu.github.io/recipe/grillrd-potato-salad
 * // http://sathyababu.github.io/recipe/grillrd-potato-salad
 *      Digital asset link file generator
 *
 * // https://github.com/sathyaBabu/sathyababu.github.io/tree/master/.well-known
 *
 *  //  asset link can be found here
 * // https://github.com/sathyaBabu/sathyababu.github.io/tree/master/.well-known/assetlinks.json
 *
 * Goofed up HERE!!!
 * Paste this link on crome to see the results
 *
 * sathyaBabu.github.io/wojtek-kalicinski.github.io-master/recipe/grilled-potato-salad/index.html
 *
 *    http://wojtek-kalicinski.github.io
 */
public class RecipeActivity extends Activity {
    ...
    private void handleIntent() {
        ...
        Uri appLinkData = appLinkIntent.getData();
        if(appLinkData != null){
            String recepieId = appLinkData.getLastPathSegment();
            Uri recepieUri = RecipeContentProvider.CONTENT_URI.buildUpon()
                    .appendPath(recepieId).build();
            showRecipe(recepieUri);
        }
    }
...
/*
<tools:validation testUrl="http://sathyababu.github.io/wojtek-kalicinski.github.io-master/recipe/grillrd-potato-salad" />
